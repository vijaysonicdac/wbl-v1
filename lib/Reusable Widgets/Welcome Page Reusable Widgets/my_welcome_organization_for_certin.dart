...
class MyWelcomeOrganizationForCertin extends StatelessWidget {
  ...
  const MyWelcomeOrganizationForCertin({
    super.key,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Dynamic list for "About" section
                      ...aboutPoints.map(
                        (point) => MyWelcomeUnorderedList(listText: point),
                      ),
