...
class TechnologyClass extends StatefulWidget {
  const TechnologyClass({super.key});

  @override
  State<TechnologyClass> createState() => TechnologyClassState();
}
...
class TechnologyClassState extends State<TechnologyClass> {
  ...
  DataRow rowdata(Map<String, dynamic> advertisementData) {
    return DataRow(cells: [
      DataCell(Text(advertisementData['T_ID'].toString())),
      DataCell(Text(
        advertisementData['Name'].toString(),
